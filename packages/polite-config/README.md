[![polite-config actions](https://github.com/DTOcean/dtocean/actions/workflows/polite-config.yml/badge.svg?branch=main)](https://github.com/DTOcean/dtocean/actions/workflows/polite-config.yml)
