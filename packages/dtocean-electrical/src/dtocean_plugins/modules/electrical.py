...
#    Copyright (C) 2016 Vincenzo Nava
...
class ElectricalInterface(ModuleInterface):
    ...
    def connect(self, debug_entry=False, export_data=False):
        ...
        if export_data:
            ...
            pkl_path = debug_path / "electrical_inputs.pkl"
        ...
        if export_data:
            ...
            pkl_path = debug_path / "electrical_outputs.pkl"
            pickle.dump(solution, open(pkl_path, "wb"))

        # Convert to MWh
        assert solution.annual_yield is not None
        ...
        assert solution.economics_data is not None
        ...
        assert solution.cable_routes is not None
        ...
        if solution.collection_points:
            assert solution.collection_points_design is not None
