...
class ElectricalSiteData:
    ...
    def __init__(
        ...
        self.min_water_depth, self.max_water_depth = seabed_range(
            self.bathymetry
        )

        self.set_target_burial_depth()

    def check_bathy_data(self, bathymetry: pd.DataFrame) -> pd.DataFrame:
...
class ElectricalMachineData:
    ...
    def get_current_ratings(self) -> float:
...
class ConfigurationOptions:
    """Container class for the configuration options defined in the core. These
        ...
        Args:
            network_configuration (list[str]) [-]: list of networks to evaluate:
                radial or star.
            export_voltage (Optional[float]) [V]: export cable voltage.
            export_cables (Optional[int]) [-]: number of export cables.
    ...
    def __init__(
        ...
        network_configuration: list[str],
        equipment_soil_compatibility: pd.DataFrame,
        export_voltage: Optional[float] = None,
        export_cables: Optional[int] = None,
        ac_power_flow: bool = True,
        target_burial_depth_array: Optional[float] = None,
        target_burial_depth_export: Optional[float] = None,
        connector_type: Optional[str] = None,
        collection_point_type: Optional[str] = None,
        ...
        self.equipment_soil_compatibility_dict = self.dict_compatibility_matrix(
            deepcopy(equipment_soil_compatibility)
        )
